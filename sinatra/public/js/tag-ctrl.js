var tagCtrl= function($scope, $http){
  ...
  $scope.get_keys= function(){
       var responsePromise = $http.get('http://ec2-54-149-45-86.us-west-2.compute.amazonaws.com:8080/tags',{ params: {'keys' : 'True'}})
  ...
  $scope.set_tags= function(query){
       ...
       var responsePromise = $http.post('http://ec2-54-149-45-86.us-west-2.compute.amazonaws.com:8080/tags',dataObject,{})
       responsePromise.success(function(dataFromServer, status, headers, config){
  ...
  $scope.get_tags= function(context){
       ...
       var responsePromise = $http.get('http://ec2-54-149-45-86.us-west-2.compute.amazonaws.com:8080/tags',{ params: {'context' : context}})
       responsePromise.success(function(dataFromServer, status, headers, config){
        $scope.tag_results = dataFromServer['results']
        $scope.tags = dataFromServer['members']
        $scope.hash_keys = Object.keys(dataFromServer['hmembers'])
  ...
  $scope.del_tags= function(query){
       ...
       var responsePromise = $http.delete('http://ec2-54-149-45-86.us-west-2.compute.amazonaws.com:8080/tags',dataObject)
       responsePromise.success(function(dataFromServer, status, headers, config){
        $scope.tag_results = dataFromServer['results']
        $scope.tags = dataFromServer['members']
       });
